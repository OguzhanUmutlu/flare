...
class ShowEntity:
    def __init__(
            self,
            value: Optional[Union[{'name': str, 'type': str, 'id': str}, Any]] = None,
            contents: Optional[Union[{'type': str, 'id': Union[list[int], str], 'name': 'Text'}, Any]] = None,
            **kwargs
    ):
        self.components = {}
        self.components.update(kwargs)
...
class ShowItem(ItemStack):
    def __init__(
            ...
            contents: Optional[Union[{'id': str, 'count': int, 'tag': str, 'components': 'DataComponentPatch'}, Any]] = None,
            **kwargs
    ):
