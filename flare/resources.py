...
from . import context
from .generated import resource as res
...
def _write_json(type_path: str, name: str, data: Any):
    data = _to_dict(data)
...
def add_advancement(name: str, data: Union[dict, 'res.Advancement']):
...
def add_banner_pattern(name: str, data: Union[dict, 'res.BannerPattern']):
    _write_json("banner_pattern", name, data)


def add_cat_variant(name: str, data: Union[dict, 'res.CatVariant']):
    _write_json("cat_variant", name, data)


def add_chat_type(name: str, data: Union[dict, 'res.ChatType']):
    _write_json("chat_type", name, data)


def add_chicken_variant(name: str, data: Union[dict, 'res.ChickenVariant']):
    _write_json("chicken_variant", name, data)


def add_cow_variant(name: str, data: Union[dict, 'res.CowVariant']):
    _write_json("cow_variant", name, data)


def add_damage_type(name: str, data: Union[dict, 'res.DamageType']):
    _write_json("damage_type", name, data)


def add_dialog(name: str, data: Union[dict, 'res.Dialog']):
    _write_json("dialog", name, data)


def add_dimension(name: str, data: Union[dict, 'res.Dimension']):
    _write_json("dimension", name, data)


def add_dimension_type(name: str, data: Union[dict, 'res.DimensionType']):
    _write_json("dimension_type", name, data)


def add_enchantment(name: str, data: Union[dict, 'res.Enchantment']):
    _write_json("enchantment", name, data)


def add_enchantment_provider(name: str, data: Union[dict, 'res.EnchantmentProvider']):
    _write_json("enchantment_provider", name, data)


def add_frog_variant(name: str, data: Union[dict, 'res.FrogVariant']):
    _write_json("frog_variant", name, data)


def add_instrument(name: str, data: Union[dict, 'res.Instrument']):
    _write_json("instrument", name, data)


def add_item_modifier(name: str, data: Union[dict, 'res.ItemModifier']):
    _write_json("item_modifier", name, data)


def add_jukebox_song(name: str, data: Union[dict, 'res.JukeboxSong']):
    _write_json("jukebox_song", name, data)


def add_loot_table(name: str, data: Union[dict, 'res.LootTable']):
    _write_json("loot_table", name, data)


def add_painting_variant(name: str, data: Union[dict, 'res.PaintingVariant']):
    _write_json("painting_variant", name, data)


def add_pig_variant(name: str, data: Union[dict, 'res.PigVariant']):
    _write_json("pig_variant", name, data)


def add_predicate(name: str, data: Union[dict, 'res.Predicate']):
    _write_json("predicate", name, data)


def add_recipe(name: str, data: Union[dict, 'res.Recipe']):
    _write_json("recipe", name, data)


def add_sulfur_cube_archetype(name: str, data: Union[dict, 'res.SulfurCubeArchetype']):
    _write_json("sulfur_cube_archetype", name, data)


def add_test_environment(name: str, data: Union[dict, 'res.TestEnvironment']):
    _write_json("test_environment", name, data)


def add_test_instance(name: str, data: Union[dict, 'res.TestInstance']):
    _write_json("test_instance", name, data)


def add_timeline(name: str, data: Union[dict, 'res.Timeline']):
    _write_json("timeline", name, data)


def add_trade_set(name: str, data: Union[dict, 'res.TradeSet']):
    _write_json("trade_set", name, data)


def add_trial_spawner(name: str, data: Union[dict, 'res.TrialSpawner']):
    _write_json("trial_spawner", name, data)


def add_trim_material(name: str, data: Union[dict, 'res.TrimMaterial']):
    _write_json("trim_material", name, data)


def add_trim_pattern(name: str, data: Union[dict, 'res.TrimPattern']):
    _write_json("trim_pattern", name, data)


def add_villager_trade(name: str, data: Union[dict, 'res.VillagerTrade']):
    _write_json("villager_trade", name, data)


def add_wolf_sound_variant(name: str, data: Union[dict, 'res.WolfSoundVariant']):
    _write_json("wolf_sound_variant", name, data)


def add_wolf_variant(name: str, data: Union[dict, 'res.WolfVariant']):
    _write_json("wolf_variant", name, data)


def add_world_clock(name: str, data: Union[dict, 'res.WorldClock']):
    _write_json("world_clock", name, data)


def add_worldgen_biome(name: str, data: Union[dict, 'res.Biome']):
    _write_json("worldgen/biome", name, data)


def add_worldgen_configured_carver(name: str, data: Union[dict, 'res.ConfiguredCarver']):
    _write_json("worldgen/configured_carver", name, data)


def add_worldgen_configured_feature(name: str, data: Union[dict, 'res.ConfiguredFeature']):
    _write_json("worldgen/configured_feature", name, data)


def add_worldgen_density_function(name: str, data: Union[dict, 'res.DensityFunction']):
    _write_json("worldgen/density_function", name, data)


def add_worldgen_noise(name: str, data: Union[dict, 'res.NoiseParameters']):
    _write_json("worldgen/noise", name, data)


def add_worldgen_noise_settings(name: str, data: Union[dict, 'res.NoiseGeneratorSettings']):
    _write_json("worldgen/noise_settings", name, data)


def add_worldgen_placed_feature(name: str, data: Union[dict, 'res.PlacedFeature']):
    _write_json("worldgen/placed_feature", name, data)


def add_worldgen_processor_list(name: str, data: Union[dict, 'res.ProcessorList']):
    _write_json("worldgen/processor_list", name, data)


def add_worldgen_structure(name: str, data: Union[dict, 'res.Structure']):
    _write_json("worldgen/structure", name, data)


def add_worldgen_structure_set(name: str, data: Union[dict, 'res.StructureSet']):
    _write_json("worldgen/structure_set", name, data)


def add_worldgen_template_pool(name: str, data: Union[dict, 'res.TemplatePool']):
    _write_json("worldgen/template_pool", name, data)


def add_worldgen_world_preset(name: str, data: Union[dict, 'res.WorldPreset']):
    _write_json("worldgen/world_preset", name, data)


def add_worldgen_flat_level_generator_preset(name: str, data: Union[dict, 'res.FlatGeneratorPreset']):
...
def add_worldgen_multi_noise_biome_source_parameter_list(name: str,
                                                         data: Union[dict, 'res.MultiNoiseBiomeSourceParameterList']):
    _write_json("worldgen/multi_noise_biome_source_parameter_list", name, data)


def add_zombie_nautilus_variant(name: str, data: Union[dict, 'res.ZombieNautilusVariant']):
